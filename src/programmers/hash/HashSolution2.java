...
public class HashSolution2 {
    ...
    public boolean solution(String[] phone_book) {
        ...
        LinkedHashMap<String, String> map = Arrays.stream(phone_book)
            .sorted()
            .collect(Collectors.toMap(String::new,
                                      Function.identity(),
                                      (v1, v2) -> v1,
                                      LinkedHashMap::new));
        ...
        for (String phoneNumber : map.keySet()) {
            ...
            if (!phoneNumber.equals(current) && phoneNumber.startsWith(current)) {
                answer = false;
                break;
            } else {
                current = phoneNumber;
    ...
    public static void main(String[] args) {
        HashSolution2 solution2 = new HashSolution2();
